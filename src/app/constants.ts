export const QUESTIONS = [
  {
    number: 1,
    question: 'What is purpose of the Angular CLI?',
    difficulty: 'Easy',
  },
  {
    number: 2,
  ...
  },
  {
    number: 3,
    question:
      'What are decorators in Angular, and can you name commonly used ones?',
    difficulty: 'Medium',
  },
  {
    number: 4,
  ...
  {
    number: 6,
    question: 'How do you manage state in an Angular application?',
    difficulty: 'Hard',
  },
  {
    number: 7,
  ...
  },
  {
    number: 8,
    question:
      'Can you explain how to use the async pipe, and what benefits it provides?',
    difficulty: 'Medium',
  },
  {
    number: 9,
